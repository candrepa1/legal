...
public class AppController {
        ...
        for (int row = 0; row < 6; row++) {
            for (int col = 0; col < 6; col++) {
                FileInputStream input = new FileInputStream(
                        "/Users/candrepa1/Desktop/Uni/legal2/legal-java/legal/src/question.jpeg");
    ...
    public void cardListener(MouseEvent event) throws FileNotFoundException {
        ...
        String image = board.board[rowSelected][colSelected].filename;

        FileInputStream imageFile = new FileInputStream(
                "/Users/candrepa1/Desktop/Uni/legal2/legal-java/legal/src/"+image+".jpeg");
