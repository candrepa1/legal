...
public class Board {
    ...
    public void populateMatrix(){
        ...
        while(!isBoardFull()){
            ...
            board[randomRow1][randomCol1] = new Cell(splittedName[0], randomImageSelected,randomRow1, randomCol1);
            board[randomRow2][randomCol2] = new Cell(splittedName[0],randomImageSelected, randomRow2, randomCol2);
